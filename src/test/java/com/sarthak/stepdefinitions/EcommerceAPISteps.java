...
public class EcommerceAPISteps {
    ...
    public void i_have_a_valid_login_request_payload() throws FileNotFoundException {
        ...
        context.getRequestMap().put("LoginAPI", request);
    }
    ...
    public void ecommerce_response_status_code_should_be(String responseType, Integer code) {
        ...
        Assert.assertEquals(
                code.intValue(),
                context.getResponseMap().get(responseType).getStatusCode()
        );
    }
    ...
    public void ecommerce_response_body_should_contain_a_valid(String responseType, String value) {
        ...
        String actualValue =
                Utils.getParsedJSONString(context.getResponseMap().get(responseType).asString(), value);
    ...
    public void ecommerce_response_body_should_contain_as(String responseType, String key, String value) {
        ...
        String actualValue =
                Utils.getParsedJSONString(context.getResponseMap().get(responseType).asString(), key);
    ...
    public void ecommerce_response_body_should_contains_valid_product_Details(String responseType) {
        ...
        ProductResponse productResponse =
                context.getResponseMap().get(responseType).as(ProductResponse.class);
        ...
        Assert.assertEquals(productResponse.getData().getProductDescription(), Utils.productData.getProductDescription());
    ...
    public void i_have_a_valid_get_product_detail_request_payload() throws FileNotFoundException {
        ...
        context.getRequestMap().put("GetProductDetailAPI",
                productService.getProduct(Utils.getProperty("productId")));
    }
    ...
    public void i_have_a_valid_get_order_request() throws FileNotFoundException {
        ...
        context.getRequestMap().put("GetOrderAPI",
                orderService.getOrder(Utils.getProperty("orders[0]")));
    }
    ...
    public void i_have_a_valid_delete_order_request_payload() throws FileNotFoundException {
        ...
        context.getRequestMap().put("DeleteOrderAPI",
                orderService.deleteOrder(Utils.getProperty("orders[0]")));
    }
    ...
    public void i_have_a_valid_delete_product_request_payload() throws FileNotFoundException {
        ...
        context.getRequestMap().put("DeleteProductAPI",
                productService.deleteProduct(Utils.getProperty("productId")));
    }

    private static final Map<String, String> RESPONSE_KEY_MAP = Map.of(
            "LoginAPI", "loginResponse",
            "AddProductAPI", "addProductResponse",
            "GetProductDetailAPI", "getProductDetailResponse",
            "AddToCartAPI", "addToCartResponse",
            "CreateOrderAPI", "createOrderResponse",
            "GetOrderAPI", "getOrderResponse",
            "DeleteOrderAPI", "deleteOrderResponse",
            "DeleteProductAPI", "deleteProductResponse"
    );
